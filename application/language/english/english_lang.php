...
$lang['clients']                                 = 'Agents';
$lang['client']                                  = 'Agent';
$lang['new_client']                              = 'New Agent';
$lang['client_lowercase']                        = 'agent';
...
$lang['contract_subject_tooltip'] = 'Subject is also visible to agent';
$lang['contract_client_string']   = 'Agent';
$lang['contract_attach']          = 'Attach document';
$lang['contract_list_client']     = 'Agent';
...
$lang['email_template_clients_fields_heading']  = 'Agents';
...
$lang['invoice_select_customer']                 = 'Agent';
...
$lang['invoice_dt_table_heading_client']         = 'Agent';
...
$lang['payments_table_client_heading']        = 'Agent';
...
$lang['report_sales_type_customer']                       = 'Agent Report';
...
$lang['reports_sales_dt_customers_client']                = 'Agent';
...
$lang['settings_group_clients']                                    = 'Agents';
$lang['settings_group_newsfeed']                                   = 'News feed';
$lang['settings_group_cronjob']                                    = 'Cron Job';
$lang['settings_yes']                                              = 'Yes';
$lang['settings_no']                                               = 'No';
$lang['settings_clients_default_theme']                            = 'Default agents theme';
$lang['settings_clients_allow_registration']                       = 'Allow agents to register';
...
$lang['ticket_client_string']                                = 'Agent';
...
# Leads
$lang['lead_convert_to_client']                = 'Convert to agent';
...
$lang['lead_email_already_exists']             = 'Lead email already exists in agents data';
$lang['lead_to_client_base_converted_success'] = 'Lead converted to agent successfully';
$lang['lead_have_client_profile']              = 'This lead have agent profile.';
$lang['lead_converted_edit_client_profile']    = 'Edit Profile';

# Invoices
$lang['view_invoice_as_customer_tooltip']                                     = 'View invoice as agent';
...
# Settings
$lang['settings_allow_payment_amount_to_be_modified'] = 'Allow agent to modify the amount to pay (for online payments)';
...
$lang['settings_rtl_support_client']                                  = 'RTL Agents Area (Right to Left)';
$lang['settings_estimate_auto_convert_to_invoice_on_client_accept']   = 'Auto convert the estimate to invoice after client accept';
$lang['settings_exclude_estimate_from_client_area_with_draft_status'] = 'Exclude estimates with draft status from agents area';
...
$lang['estimate_select_customer']                 = 'Agent';
...
$lang['estimate_dt_table_heading_client']         = 'Agent';
...
$lang['customers_summary']                 = 'Agent Summary';
...
$lang['expense_add_edit_customer']                    = 'Agent';
...
$lang['expense_dt_table_heading_customer']            = 'Agent';
...
$lang['expense_recurring_send_custom_on_renew']       = 'Send the invoice to agent email when expense re-created';
$lang['expense_recurring_autocreate_invoice_tooltip'] = 'If this option is checked the invoice for the agent will be auto created when the expense will be renewed.';
...
$lang['custom_field_customers']   = 'Agent';
...
# Agents & Invoices / Estimates
$lang['ship_to']                            = 'Ship to';
$lang['customer_profile_details']           = 'Agent Details';
...
$lang['get_shipping_from_customer_profile'] = 'Get shipping details from agent profile';
...
$lang['setup_google_api_key_customer_map']                     = 'Setup google api key in order to view to agent map';
$lang['customer_attachments_file']                             = 'File';
$lang['client_send_set_password_email']                        = 'Send SET password email';
$lang['customer_billing_same_as_profile']                      = 'Same as Agent Info';
...
# Contacts
$lang['contract_not_visible_to_client'] = 'Hide from agent';
...
$lang['show_customer_reminders_on_calendar']                                 = 'Agent Reminders';

# Leads
$lang['copy_custom_fields_convert_to_customer']                      = 'Copy custom fields to agent profile';
$lang['copy_custom_fields_convert_to_customer_help']                 = 'If any of the following custom fields do not exists for agent will be auto created with the same name otherwise only the value will be copied from the lead profile.';
$lang['lead_profile']                                                = 'Profile';
$lang['lead_is_client']                                              = 'Agent';
...
$lang['import_customers']            = 'Import Agents';
...
$lang['set_reminder_tooltip']    = 'This option allows you to never forget anything about your agents.';
...
# Estimates
$lang['view_estimate_as_client']         = 'View estimate as agent';
...
$lang['proposals_customers_related']            = 'Agent Related';
$lang['proposal_related']                       = 'Related';
$lang['proposal_for_lead']                      = 'Lead';
$lang['proposal_for_customer']                  = 'Agent';
...
$lang['proposal_convert_to_lead_disabled_help'] = 'You need to convert the lead to agent in order to create %s';
$lang['proposal_convert_not_related_help']      = 'The proposal needs to be related to agent in order to convert to %s';
...
# Agent Groups
$lang['customer_group_add_heading']      = 'Add New Agent Group';
$lang['customer_group_edit_heading']     = 'Edit Agent Group';
$lang['new_customer_group']              = 'New Agent Group';
$lang['customer_group_name']             = 'Name';
$lang['customer_groups']                 = 'Groups';
$lang['customer_group']                  = 'Agent Group';
$lang['customer_group_lowercase']        = 'Agent group';
...
# Reports
$lang['report_by_customer_groups'] = 'Total Value By Agent Groups';
...
$lang['not_invoice_sent_to_customer']                             = 'Invoice Sent to Agent: %s';
...
$lang['not_lead_activity_converted_email']                        = 'Lead email changed. First lead email was: %s and added as agent with email %s';
$lang['not_lead_activity_converted']                              = '%s Converted this lead to agent';
...
$lang['not_proposal_comment_from_client']                         = 'New comment from agent on proposal %s ...';
...
$lang['estimate_activity_client_accepted_and_converted']          = 'Agent accepted this estimate. Estimate is converted to invoice with number %s';
$lang['estimate_activity_client_accepted']                        = 'Agent accepted this estimate';
...
$lang['invoice_activity_sent_to_client_cron']                     = 'Invoice sent to agent by CRON';
$lang['invoice_activity_sent_to_client']                          = 'sent invoice to agent';
...
$lang['report_invoice_customer']          = 'Agent';
...
$lang['settings_client_staff_add_edit_delete_task_comments_first_hour'] = 'Allow agent/staff to add/edit task comments only in the first hour (administrators not applied)';
...
$lang['customer_from_lead']        = 'Agent from %s';
...
$lang['task_visible_to_client'] = 'Visible to agent';
...
# General
$lang['is_customer_indicator']         = 'Agent';
$lang['print']                         = 'Print';
...
$lang['project_view_as_client']                              = 'View project as Agent';
...
$lang['project_file_visible_to_customer']                    = 'Visible to Agent';
...
$lang['project_allow_client_to']                             = 'Allow Agent to %s';
...
$lang['project_discussion_show_to_customer']                 = 'Visible to Agent';
...
$lang['project_activity_visible_to_customer']          = 'Visible to Agent';
...
$lang['no_primary_contact']                      = 'This Agent does have primary contact. You need to setup primary contact login as agent. Its recommended all agents to have primary contacts.';
$lang['leads_merge_customer']                    = 'Agent fields merging';
...
$lang['contract_sent_to_client_success']          = 'The contract is successfully sent to the agent';
...
$lang['total_clients_deleted']                            = 'Total agents deleted: %s';
...
$lang['customers_summary_total']                          = 'Total Agents';
...
$lang['notification_when_customer_pay_invoice'] = 'Receive notification when agent pay invoice (built-in)';
...
$lang['allow_customer_to_change_ticket_status'] = 'Allow agent to change ticket status from agents area';
...
$lang['lead_lock_after_convert_to_customer']    = 'Do not allow leads to be edited after they are converted to agents (administrators not applied)';
...
$lang['customer_admins']                        = 'Agents Admins';
$lang['assign_admin']                           = 'Assign Admin';
$lang['customer_admin_date_assigned']           = 'Date Assigned';
$lang['customer_admin_login_as_client_message'] = 'Hello %s. You are added as admin to this agent.';
...
# Version 1.1.9
$lang['use_recaptcha_customers_area']    = 'Enable reCAPTCHA on agent area (Login/Register)';
...
$lang['swap_pdf_info']                            = 'Swap Company/Agent Details (company details to right side, agent details to left side)';
...
$lang['show_to_customer']                         = 'Show to agent';
$lang['hide_from_customer']                       = 'Hide from agent';
...
$lang['description_visible_to_customer']        = 'Show description to agent';
...
$lang['custom_field_disallow_customer_to_edit'] = 'Disallow agent to edit this field';
...
$lang['do_not_send_invoice_payment_email_template_contact'] = 'Do not send invoice payment recorded email to agent contacts';
...
$lang['only_show_contact_tickets']                          = 'In agents area only show tickets related to the logged in contact (Primary contact not applied)';
$lang['cancel_overdue_reminders_invoice']                   = 'Prevent sending overdue reminders for this invoice';
$lang['customer_shipping_address_notice']                   = 'Do not fill shipping address information if you won\'t use shipping address on agent invoices';
...
$lang['exclude_invoices_draft_from_client_area']            = 'Exclude invoices with draft status from agents area';
$lang['invoice_draft_status_info']                          = 'This invoice is with status Draft, status will be auto changed when you send the invoice to the agents or mark as sent.';
...
$lang['customer_currency_change_notice']           = 'If the agent use other currency then the base currency make sure you select the appropriate currency for this agent. Changing the currency is not possible after transactions are recorded.';
...
$lang['sending_email_contact_permissions_warning'] = 'Failed to auto select agent contacts. Please make sure that the agent have associated contacts with permission %s';
...
$lang['leads_report_converted_notice']                        = 'Only leads that belongs in the default Agent status will be taken as converted leads, if the leads belongs to the default status client and its not converted to agent will be still counted as converted lead';
...
$lang['auto_assign_customer_admin_after_lead_convert']      = 'Auto assign as admin to agent after convert';
$lang['auto_assign_customer_admin_after_lead_convert_help'] = 'If this option is set to YES the staff member that converted lead to agent will be auto assigned as agent admin. NOTE: This option will apply only on staff members that do not have permission for agents VIEW';
...
$lang['bulk_action_customers_groups_warning']        = 'If you do not select any group all groups assigned to the selected agents will be removed.';
$lang['customer_attachments_show_in_customers_area'] = 'Show to agents area';
$lang['customer_attachments_show_notice']            = 'Only files uploaded from agent profile have ability to show/hide in agents area.';
...
$lang['customer_inactive_message']               = 'This is inactive agent profile and some features may be disabled';
$lang['active_customers']                        = 'Active Agents';
$lang['inactive_active_customers']               = 'Inactive Agents';
...
$lang['permission_customers_based_on_admins']               = 'Based on agent admins';
...
$lang['allow_contact_to_delete_files']                      = 'Allow contacts to delete own files uploaded from agents area';
$lang['file']                                               = 'File';
$lang['customer_contact_person_only_one_allowed']           = 'Only 1 contact is allowed when the company field is not filled. The system will cast this agent as person';
...
$lang['only_own_files_contacts']                                 = 'Contacts see only own files uploaded in agent area (files uploaded in agent profile)';
$lang['only_own_files_contacts_help']                            = 'If you share the file manually from agent profile to other contacts they wil be able to see the file.';
...
$lang['staff_members_open_tickets_to_all_contacts_help'] = 'If staff member don\'t have permission for agents VIEW only will be able to create new tickets from admin area to agent contacts where is assigned as agent admin.';
...
$lang['no_vault_entries']                         = 'Vault entries not found for this agent.';
$lang['vault_entry_created_from']                 = 'This vault entry is created by %s';
$lang['vault_entry_last_update']                  = 'Last updated by %s';
$lang['vault_entry_visible_to_all']               = 'Visible to all staff member who have access to this agent';
...
$lang['exclude_proposal_from_client_area_with_draft_status'] = 'Exclude proposals with draft status from agents area';
...
$lang['customer_statement_for']                              = 'Agent Statement For %s';
...
$lang['project_shared_vault_entry_login_details']            = 'View Agent Site Login Details';
...
$lang['project_marked_as_finished_to_contacts']        = 'Send <b>Project Marked as Finished</b> email to agent contacts';
...
$lang['customer_info_format']                    = 'Agent Information Format (PDF and HTML)';
...
$lang['transfer_lead_notes_to_customer']         = 'Transfer lead notes to agent profile';
...
$lang['custom_field_pdf_html_help']                        = 'Make sure you check ' . $lang['custom_field_show_on_client_portal'] . ' field if you want the custom fields to be visible to agents area and when agent download PDF or receive PDF via email.';
$lang['auto']                                              = 'Auto';
...
$lang['reccuring_invoice_option_gen_and_send']             = 'Generate and autosend the renewed invoice to the agent';
...
# Version 1.9.5
$lang['customers_assigned_to_me']              = 'Agent assigned to me';
...
$lang['credit_note_send_to_client_modal_heading']                = 'Send Credit Note To Agent';
...
$lang['credit_note_no_invoices_available']                       = 'There are no available invoices for this agent.';
...
$lang['lead_is_contact_create_task']              = 'Create task if email sender is already agent and assign to responsible staff member.';
$lang['existing_customer']                        = 'Existing Agent';
$lang['use_company_name_instead']                 = 'Use company name instead';
$lang['customer_delete_transactions_warning']     = 'This agent has transactions, %s, you must delete the transactions or move to another agent in order to perform this action.';

# Version 1.9.8
$lang['sending_email_contact_permissions_warning'] = 'Failed to auto select agent contacts. Make sure that the agent has active contacts and associated contacts with email notifications for %s enabled.';
...
$lang['ideal_customer_statement_descriptor']       = 'Statement Descriptor (shown in agent bank statement)';
...
$lang['not_viewed_yet']                                         = 'This %s is not viewed yet by the agent';
$lang['undo']                                                   = 'Undo';
...
$lang['keep_signature']                                         = 'Keep Agent Signature';
...
$lang['not_contract_comment_from_client']                       = 'New comment from agent on contract %s ...';
...
$lang['show_subscriptions_in_customers_area']                   = 'Show subscriptions in agents area?';
$lang['show_subscriptions_in_customers_area_help']              = 'This option is valid only for the agent primary contact.';
...
$lang['subscription_not_yet_subscribed']                        = 'Agent is not yet subscribed to this subscription.';
...
$lang['view']                                                   = 'View';
$lang['customer_is_subscribed_to_subscription_info']            = 'The agent is subscribed to this subscription';
...
$lang['customers_register_require_confirmation']                = 'Require registration confirmation from administrator after agent register';
...
$lang['customer_registration_successfully_confirmed']           = 'Agent registration successfully confirmed';
...
$lang['not_contract_signed']                            = 'Contract with subject %s has been signed by the agent';
$lang['the_number_sign']                                = '#';
$lang['not_new_ticket_reply']                           = 'Agent replied to ticket - %s';
$lang['receive_notification_on_new_ticket_replies']     = 'Receive notification when agent reply to a ticket';
$lang['receive_notification_on_new_ticket_reply_help']  = 'All staff members which belong to the ticket department will receive notification when agent reply to a ticket';
...
$lang['company_exists_info']                                         = 'It looks that a agent with name %s already exists, if you still want to create the agent you can ignore this message.';
...
# Version 2.2.1
$lang['customer_files_info_message'] = 'Files from projects and tasks linked to the agent are not shown on this table.';
...
$lang['attach_statement']            = 'Attach Agent Statement';
...
$lang['subscriptions_terms_info']                  = 'Enter agent terms & conditions to be displayed to the agent before subscribe to the subscription.';
...
$lang['subscription_first_billing_date_info']      = 'Leave blank to use date when the agent is subscribed to the subscription. This field must be future date, if you select date and the date is passed but agent is not yet subscribed, the date when the agent will subscribe will be used.';
...
$lang['allow_primary_contact_to_manage_other_contacts']       = 'Allow primary contact to manage other agent contacts';
$lang['contact_form_validation_is_unique']                    = 'Contact with this {field} already exists in our system';
$lang['invoice_number_not_applied_on_draft']                  = 'If the invoice is saved as draft, the number won\'t be applied, instead, the next invoice number will be given when the invoice is sent to the agent or is marked as sent.';
...
$lang['estimate_request_for_customer']                     = 'Agent';
$lang['estimate_request_related']                          = 'Related to';
$lang['estimate_request_client_created_success']           = 'Estimate Request Agent Created';
...
$lang['due_reminders_for_invoices_info'] = 'Due reminders are sent to unpaid and partially paid invoices as reminder to the agent to pay the invoice before is due.';
...
$lang['show_estimate_request_in_customers_area']              = 'Show Estimate request link in agents area?';
...
$lang['hide_milestone_from_customer']              = 'Hide from agent';
$lang['hide_milestone_from_customer_help']         = 'When you decide to hide milestone from the agent area, the whole milestone and its tasks will be hidden';
...
$lang['batch_payment_filter_by_customer']                 = 'Filter invoices by agent';
$lang['batch_payments']                                   = 'Batch Payments';
$lang['batch_payment_added_successfully']                 = 'You have successfully added %s payments';
$lang['batch_payments_send_invoice_payment_recorded']     = 'Do not send invoice payment recorded email to agent contacts';
