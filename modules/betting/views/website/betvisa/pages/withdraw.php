    ...
    <div class="depositeWidthraw">
            <div class="tab-pane fade active show" id="nav-deposite" role="tabpanel" aria-labelledby="nav-deposite-tab">
                ...
                <div class="deposit-wrapper mt-3">
                    ...
                    <h6 class="mb-2 fw-bold thme-white-black-text">Online Gateway</h6>
                                ...
                                <div class="tab-pane fade active show  deposit-btn-plece border-0 " role="tabpanel" aria-labelledby="">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <form action="" class="change-password-form">
                                                    ...
                                                    <div class=" input_solt " style="60px !important;">
                                                       <div class="input-group v-login-input-field position-relative mx-2" data-select2-id="4">
                                                        ...
                                                        <select class="form-control selection_select2 " name="BankCode" id="BankCode" data-select2-id="BankCode" tabindex="-1" aria-hidden="true">
                                                            ...
                                                            <option value="2001">BKASH</option>
                                                            <option value="2002">ROCKET</option>
                                                            <option value="2003">UPPAY</option>
                                                            <option value="2004">NAGAD</option>
                                                         </select>
                                                    </div>
                                                    </div>
                                                </div>
                                            ...
                                            <?php }
                                            else if($currency->name=='INR'){ ?>
                                                 <div class="mb-3">
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <label class="mb-2 thme-white-black-text" for="">AccountIFSC</label>
                                                    </div>
                                                    <div class="input-group input_solt mr-sm-2">
                                                        <input type="text" class="form-control" class="form-control"  id="AccountIFSC">
                                                    </div>
                                                </div>
                                            <?php }   ?>
                                           ...
                                           <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <label class="mb-2 thme-white-black-text" for="">Amount (<?= get_settle_balance($this->session->userdata('logged_in')->id) ?>)</label>
                                                    <div class="text-danger fs-12"><i class="fa-solid fa-circle-info"></i> Min/Max Limit: 300/25,000</div>
                                                </div>

                                                <div class="input-group input_solt mr-sm-2">
                                                    <input type="text" class="form-control" class="form-control" placeholder="Min 300"  id="amount">
                                                </div>
                                            ...
                                            <button type="button" onclick="withdraw()" class="changebtn depositbtn">Withdraw</button>

                                            <div id="" class="text-danger fs-12" style="display: none;">Min/Max Limit: 300/25,000</div>
...
function withdraw(){
    ...
    if(amount>=300){
        ...
        if(currency=='BDT'){
            ...
            if(!MerchantNotes){
                alert('Please enter AccountIFSC');
                error=true;
            }
            
        }
        if(!error){
            $.post('<?= site_url(BETTING_MODULE_NAME . '/withdraw_g1_ajax') ?>', {
                    amount: amount,
                    BankCode:BankCode,
